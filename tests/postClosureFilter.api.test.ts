/**
 * Server-side tests — POST /api/providers (update branch) strips expired closedDates.
 *
 * Confirms that when the authenticated user already has a provider, the POST
