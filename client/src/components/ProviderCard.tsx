...
export default function ProviderCard({ provider, onViewDetails, onRequestInfo, onAddToComparison, onRemoveFromComparison, isInComparison = false }: ProviderCardProps) {
  ...
  const closedToday = isClosedToday(provider.closedDates);
    ...
    <>
      ...
      <CardContent className="p-6">
        ...
        <div className="flex flex-wrap gap-2 mb-3">
          ...
          {provider.enrollmentStatus === "accepting" && (
          ...
          {provider.enrollmentStatus === "waitlist" && (
          ...
          {provider.enrollmentStatus === "full" && (
          ...
          {closedToday && (
            <Badge className="rounded-full text-xs font-medium bg-red-100 text-red-700 border border-red-300">
              🔴 Closed today
            </Badge>
          )}
          {!closedToday && closingSoonEntry && (
